...
int main(int argc, char *argv[])
{
    ...
    thrust::dev_ptr<int> dev_ptr(d_a);
    ...
    thrust::dev_ptr<int> dev_ptr(d_a + pinned_size);
    ...
    thrust::dev_ptr<int> dev_ptr(d_a + pinned_size * 2);
    thrust::sort(thrust::cuda::par.on(stream1), dev_ptr, dev_ptr + pinned_size);
    ...
    thrust::dev_ptr<int> dev_ptr(d_a + pinned_size * 3);
    thrust::sort(thrust::cuda::par.on(stream2), dev_ptr, dev_ptr + pinned_size);
    ...
    thrust::dev_ptr<int> dev_ptr(d_a + pinned_size * 4);
    thrust::sort(thrust::cuda::par.on(stream1), dev_ptr, dev_ptr + pinned_size);
    ...
    thrust::dev_ptr<int> dev_ptr(d_a + pinned_size * 5);
    thrust::sort(thrust::cuda::par.on(stream2), dev_ptr, dev_ptr + pinned_size);

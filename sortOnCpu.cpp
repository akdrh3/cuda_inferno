...
bool stageCheck(const double* vector,const long long unsigned int* myWorkingRange){
...
void* mergeSortThread(){
    ...
    double* toSort=parameters.toSort;
    double* vector1=parameters.vector1;
    double* vector2=parameters.vector2;
...
void mergeSort(double* toSort,long long unsigned int length,int threadNumber){
    ...
    double* vector1=(double*)malloc(sizeof(double)*lengthPower2);
    double* vector2=(double*)malloc(sizeof(double)*lengthPower2);
